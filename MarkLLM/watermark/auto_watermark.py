...
WATERMARK_MAPPING_NAMES={
    # 'bytekgwV2': 'watermark.bytekgwV2.ByteKGW',
    'bytekgw': 'watermark.bytekgwV5.ByteKGW',
    ...
    'TS':'watermark.ts.TS',
    'SemStamp':'watermark.ss.SemStamp',
}
...
class AutoWatermark:
    ...
    def load(algorithm_name, algorithm_config=None, transformers_config=None, *args, **kwargs):
        ...
        module = importlib.import_module('MarkLLM.'+module_name)
